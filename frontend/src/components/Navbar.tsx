...
const Navbar = ({ write = true }: { write: boolean }) => {
                        ...
                        {!hover ? (
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex justify-center gap-1 cursor-pointer ">
                                    <div
                                        ...
                                        className="border-b-4 flex gap-x-2">
                                        <span className="first-letter:uppercase">{userDetails.name}</span>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    />
                                    <div className="flex justify-center gap-1 cursor-pointer">
                                        <div className="border-b-4 border-blue-950 flex gap-x-2">
                                            <span className="first-letter:uppercase">{userDetails.name}</span>
                                            <span className="relative bottom-1 font-bold">
                                                &#8964;
                                            </span>
